...
server.tool(
  ...
  { project_id: z.string(), status: z.string() },
  async (input) => {
...
server.tool(
  ...
  { project_id: z.string(), role: z.string() },
  async (input) => {
...
server.tool(
  ...
  { project_id: z.string(), active_only: z.boolean().optional() },
  async (input) => {
...
server.tool(
  ...
  { project_id: z.string(), title: z.string(), description: z.string(), assignee_id: z.string().optional() },
  async (input) => {
...
server.tool(
  ...
  { task_id: z.string(), status: z.string().optional(), description: z.string().optional(), assignee_id: z.string().optional() },
  async (input) => {
...
server.tool(
  ...
  { project_id: z.string(), assignee_id: z.string().optional(), status: z.string().optional() },
  async (input) => {
...
server.tool(
  ...
  { task_id: z.string(), member_id: z.string(), entry_type: z.string(), content: z.string() },
  async (input) => {
...
server.tool(
  ...
  { member_id: z.string(), task_id: z.string().optional() },
  async (input) => {
...
server.tool(
  ...
  { member_id: z.string(), project_id: z.string() },
  async (input) => {
...
server.tool(
  ...
  { task_id: z.string(), member_id: z.string(), content: z.string() },
  async (input) => {
...
server.tool(
  ...
  { discussion_id: z.string(), member_id: z.string() },
  async (input) => {
...
server.tool(
  ...
  { discussion_id: z.string(), member_id: z.string(), content: z.string() },
  async (input) => {
...
server.tool(
  ...
  { discussion_id: z.string(), summary: z.string() },
  async (input) => {
...
server.tool(
  ...
  { project_id: z.string(), participant_id: z.string().optional() },
  async (input) => {
...
server.tool(
  ...
  { artifact_id: z.string(), content: z.string(), title: z.string().optional() },
  async (input) => {
...
server.tool(
  ...
  { project_id: z.string(), artifact_type: z.string().optional() },
  async (input) => {
